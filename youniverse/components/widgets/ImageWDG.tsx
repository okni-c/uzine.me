export default function ImageWDG ({ src, id, caption }: any) {
    return (
        <div className='w-full h-full flex flex-col relative rounded-2xl'>
            <img src={src ? src : '/mountains_placeholder.png'} className='h-full w-full object-cover rounded-2xl pointer-events-none select-none border-2 border-[rgba(12, 12, 12, 0.19)]' />
