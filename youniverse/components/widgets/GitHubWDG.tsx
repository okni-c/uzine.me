export default function GitHubWDG() {
    return (
        <div className='w-full h-full flex flex-col gap-4 relative rounded-2xl p-4 bg-white border border-[rgba(12, 12, 12, 0.19)]'>
            ...
            <p className="text-[#454545] font-bold text-lg">@okni-c</p>
